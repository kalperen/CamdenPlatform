...
void http_run(float measurement)
{
    if (platform_init() != 0)
    {
    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                myWeather = CREATE_MODEL_INSTANCE(Model, LightSensor);
                if (myWeather == NULL)
                {
                ...
                else
                {
                    ...
                    else
                    {
                          ...
                          myWeather->SensorType = "Light";
                          myWeather->MeasurementUnit = "Lux";
                          myWeather->Value = measurement;
...
void run(float measurement)
{
    http_run(measurement);
}
